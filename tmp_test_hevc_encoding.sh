...
ffmpeg -y -f rawvideo -vcodec rawvideo -pix_fmt gray -s 2560x2560 -r 1 -i ${video_input_path} -codec:v libx265 -x265-params "keyint=1:min-keyint=1:scenecut=0:bframes=0:b-adapt=0:qp=34" -c:a copy ${video_output_path}
# Check the PSNR
